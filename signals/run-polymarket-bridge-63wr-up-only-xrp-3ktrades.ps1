...
$ConfigName = '63wr-up-only-xrp-3ktrades'
$ConfigSlug = '63wr-up-only-xrp-3ktrades'
$StrategyKey = 'deadzone_orb_proxy_breakout'
$Symbol = 'XRPUSDT'
$Interval = '5m'
$BotSymbol = 'xrp'
...
$ParamsJson = @'
{
  "deadzoneLookback": 130,
  "efficiencyCeiling": 0.6001,
  "breakoutZscore": -1.3988
}
'@
