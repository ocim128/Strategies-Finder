...
function fakeDom(): BatchBacktestDom {
    ...
    return {
        ...
        batchBacktestDirectionForecastBtn: el(),
        batchBacktestCopyDirectionForecastBtn: el(),
        batchBacktestDirectionForecastSummary: el(),
        batchBacktestDirectionForecastResults: el(),
