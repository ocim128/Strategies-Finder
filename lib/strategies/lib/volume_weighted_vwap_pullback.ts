...
function normalizeParams(params: StrategyParams): StrategyParams {
    return {
        ...
        minVolumePercentile: Number(params.minVolumePercentile ?? 0.7),
    };
}

export const volume_weighted_vwap_pullback: Strategy = {
    ...
    execute: (data: OHLCVData[], params: StrategyParams) => {
        ...
        return createSignalLoop(cleanData, [vwap, vwapRoc, volPct, closeLoc], (i) => {
            ...
            const minVol = p.minVolumePercentile as number;

            // Buy: touches/crosses from above, long-term VWAP slope positive, volume percentile high, and close location gradient positive
            ...
            // Sell: touches/crosses from below, long-term VWAP slope negative, volume percentile high, and close location gradient negative
