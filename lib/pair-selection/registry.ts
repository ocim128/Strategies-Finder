...
import { canary_leader_gate } from "./canary_leader_gate";
import { cleanliness_lottery_pick } from "./cleanliness_lottery_pick";
import { cohort_alignment_regime_switch } from "./cohort_alignment_regime_switch";
import { cohort_normalized_directional_rank } from "./cohort_normalized_directional_rank";
import { cohort_vice_champion } from "./cohort_vice_champion";
...
import { decisive_leader_gate } from "./decisive_leader_gate";
...
import { direction_asymmetry_test } from "./direction_asymmetry_test";
import { dip_share_regime_switch } from "./dip_share_regime_switch";
import { dual_cohort_champion } from "./dual_cohort_champion";
import { dual_visibility_percentile } from "./dual_visibility_percentile";
...
import { efficiency_maturity_rank_product } from "./efficiency_maturity_rank_product";
import { efficiency_skew_regime_switch } from "./efficiency_skew_regime_switch";
...
import { event_acceleration_regime_switch } from "./event_acceleration_regime_switch";
import { event_horizon_conflict_regime_switch } from "./event_horizon_conflict_regime_switch";
import { elite_decile_fnv_pick } from "./elite_decile_fnv_pick";
import { escape_hatch_union_pick } from "./escape_hatch_union_pick";
import { experience_payoff_regime_switch } from "./experience_payoff_regime_switch";
...
import { fresh_pair_momentum_weight } from "./fresh_pair_momentum_weight";
import { global_podium_rank_pick } from "./global_podium_rank_pick";
import { hub_cluster_momentum_excess } from "./hub_cluster_momentum_excess";
import { horizon_conflict_lottery_pick } from "./horizon_conflict_lottery_pick";
...
import { minority_direction_momentum_weight } from "./minority_direction_momentum_weight";
import { momentum_maturity_rank_product } from "./momentum_maturity_rank_product";
import { momentum_percentile_target } from "./momentum_percentile_target";
import { mover_heat_exclusion } from "./mover_heat_exclusion";
import { market_coherence_regime_switch } from "./market_coherence_regime_switch";
import { negative_autocorrelation_bounce_projection } from "./negative_autocorrelation_bounce_projection";
import { one_leg_theme_drift } from "./one_leg_theme_drift";
import { pareto_undominated_pick } from "./pareto_undominated_pick";
import { pre_event_vol_scaled_momentum } from "./pre_event_vol_scaled_momentum";
import { persistence_regime_switch } from "./persistence_regime_switch";
...
import { scale_diffusion_residual } from "./scale_diffusion_residual";
import { scale_ambiguity_veto } from "./scale_ambiguity_veto";
import { slow_breadth_regime_switch } from "./slow_breadth_regime_switch";
import { slope_return_rank_gap } from "./slope_return_rank_gap";
...
import { tail_excluded_fnv_pick } from "./tail_excluded_fnv_pick";
import { theme_tightness_weight } from "./theme_tightness_weight";
import { theme_decisiveness_regime_switch } from "./theme_decisiveness_regime_switch";
import { turn_of_month_momentum_switch } from "./turn_of_month_momentum_switch";
...
import { worst_horizon_momentum } from "./worst_horizon_momentum";
import { unanimous_trend_lottery_pick } from "./unanimous_trend_lottery_pick";
import { winner_tightness_regime_switch } from "./winner_tightness_regime_switch";
import type { PairSelectionRule } from "./types";

const pairSelectionRuleDefinitions = [
    adverse_channel_bounce_proximity,
    adverse_increment_streak_rebound,
    autocorr_penalized_drift,
    ...
    canary_leader_gate,
    cleanliness_lottery_pick,
    cohort_alignment_regime_switch,
    cohort_normalized_directional_rank,
    cohort_vice_champion,
    ...
    direction_asymmetry_test,
    dip_share_regime_switch,
    dual_cohort_champion,
    dual_visibility_percentile,
    ...
    efficiency_maturity_rank_product,
    efficiency_skew_regime_switch,
    ...
    event_acceleration_regime_switch,
    event_horizon_conflict_regime_switch,
    elite_decile_fnv_pick,
    escape_hatch_union_pick,
    experience_payoff_regime_switch,
    fast_halflife_adverse_displacement,
    fresh_trend_emergence_ratio,
    fresh_pair_momentum_weight,
    global_podium_rank_pick,
    hub_cluster_momentum_excess,
    horizon_conflict_lottery_pick,
    ...
    minority_direction_momentum_weight,
    momentum_maturity_rank_product,
    momentum_percentile_target,
    mover_heat_exclusion,
    market_coherence_regime_switch,
    negative_autocorrelation_bounce_projection,
    one_leg_theme_drift,
    pareto_undominated_pick,
    pre_event_vol_scaled_momentum,
    persistence_regime_switch,
    ...
    scale_diffusion_residual,
    scale_ambiguity_veto,
    slow_breadth_regime_switch,
    slope_return_rank_gap,
    ...
    tail_excluded_fnv_pick,
    theme_tightness_weight,
    theme_decisiveness_regime_switch,
    turn_of_month_momentum_switch,
    ...
    worst_horizon_momentum,
    unanimous_trend_lottery_pick,
    winner_tightness_regime_switch,
