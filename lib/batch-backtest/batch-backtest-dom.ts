...
export const BATCH_BACKTEST_REQUIRED_IDS = [
    ...
    "batchBacktestSp500TopMeanStabilityEnabled",
    "batchBacktestSp500TopMeanStabilityDates",
    "batchBacktestSp500TopMeanStabilityRunBtn",
...
export function createBatchBacktestDom() {
    return {
        ...
        batchBacktestSp500TopMeanStabilityEnabled: getRequiredElement<HTMLInputElement>("batchBacktestSp500TopMeanStabilityEnabled"),
        batchBacktestSp500TopMeanStabilityDates: getRequiredElement<HTMLInputElement>("batchBacktestSp500TopMeanStabilityDates"),
        batchBacktestSp500TopMeanStabilityRunBtn: getRequiredElement<HTMLButtonElement>("batchBacktestSp500TopMeanStabilityRunBtn"),
