...
export const BATCH_BACKTEST_REQUIRED_IDS = [
    ...
    "batchBacktestDirectionForecastBtn",
    "batchBacktestCopyDirectionForecastBtn",
    "batchBacktestDirectionForecastSummary",
    "batchBacktestDirectionForecastResults",
...
export function createBatchBacktestDom() {
    return {
        ...
        batchBacktestDirectionForecastBtn: getRequiredElement<HTMLButtonElement>("batchBacktestDirectionForecastBtn"),
        batchBacktestCopyDirectionForecastBtn: getRequiredElement<HTMLButtonElement>("batchBacktestCopyDirectionForecastBtn"),
        batchBacktestDirectionForecastSummary: getRequiredElement<HTMLDivElement>("batchBacktestDirectionForecastSummary"),
        batchBacktestDirectionForecastResults: getRequiredElement<HTMLDivElement>("batchBacktestDirectionForecastResults"),
