...
export const BATCH_BACKTEST_REQUIRED_IDS = [
    ...
    "batchBacktestExposureBtn",
    "batchBacktestCopyExposureBtn",
    "batchBacktestExposureSummary",
...
export function createBatchBacktestDom() {
    return {
        ...
        batchBacktestExposureBtn: getRequiredElement<HTMLButtonElement>("batchBacktestExposureBtn"),
        batchBacktestCopyExposureBtn: getRequiredElement<HTMLButtonElement>("batchBacktestCopyExposureBtn"),
        batchBacktestExposureSummary: getRequiredElement<HTMLDivElement>("batchBacktestExposureSummary"),
